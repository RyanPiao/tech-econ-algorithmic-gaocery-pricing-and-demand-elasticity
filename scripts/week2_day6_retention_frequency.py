#!/usr/bin/env python3
"""Week 2 Day 6: medium-run retention/frequency elasticity outcomes."""
...
def plot_response_curve(base: pd.DataFrame) -> None:
    ...
    ax1.set_xlabel("Average ln effective price (current week)")
    ...
    plt.title("Week 2 Day 6: Medium-Run Retention/Frequency Response")
    fig.tight_layout()
...
def main() -> None:
    ...
    print("Week2 Day6 outputs generated:")
    for path in [
